...
const MemoryDB = require('../memory/memory-db'); // Temporary until we add DynamoDB
...
async function deleteFragment(ownerId, id) {
  ...
  try {
    ...
    logger.info({ Bucket: s3Params.Bucket, Key: s3Params.Key }, 'S3 object deleted successfully.');
  } catch (err) {
    logger.error({ err }, 'Error deleting fragment data from S3');
